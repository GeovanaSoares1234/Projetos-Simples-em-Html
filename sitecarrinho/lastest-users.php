...
$pdf -> Cell(16, 3, "Clientes mais recentes", 1, 1, "C", TRUE);
...
$sql = "SELECT nome, create_date, email FROM usuarios ORDER BY create_date DESC";
$select = mysqli_query($_conecta, $sql) or die(mysqli_error());
